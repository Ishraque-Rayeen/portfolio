...
export default function Intro() {
  ...
  return (
    ...
    >
      <div className="flex items-center justify-center">
        <div className="relative">
          ...
          <motion.span
            ...
            animate={{ opacity: 1, scale: 1 }}
            transition={{
              type: "spring", //this sets bouncing
              stiffness: 125, //set how much bounciness
              delay: 0.1,
              duration: 0.7,
            }}
          >
      ...
      >
        <span className="font-bold">Hello, I'm Ishraq.</span> I'm a{" "}
      ...
      >
        ...
        <div className="flex gap-6 mt-6 sm:mt-0 sm:gap-2">
          {" "}
          <a
            ...
            href="https://linkedin.com/in/ishraque-rayeen"
            target="_blank"
          >
            <BsLinkedin />
          </a>
          <a
            className="bg-white p-4 text-gray-700 hover:text-gray-950 flex items-center gap-2 text-[1.35rem] rounded-full focus:scale-[1.15] hover:scale-[1.15] active:scale-105 transition cursor-pointer borderBlack  dark:bg-white/10 dark:text-white/60"
            href="https://github.com/Ishraque-Rayeen"
            target="_blank"
          >
            <FaGithubSquare />
          </a>
